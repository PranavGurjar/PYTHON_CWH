...
BASE_PATH = 'F:/Python/CWH_Python/Python_Day2/02-Day2-Application-of-Python/5. Snake Game/'
...
bg2 = pygame.image.load(BASE_PATH + "Screen/bg2.jpg")
intro = pygame.image.load(BASE_PATH + "Screen/intro1.png")
outro = pygame.image.load(BASE_PATH + "Screen/outro.png")
...
#Music
pygame.mixer.music.load(BASE_PATH + 'music/wc.mp3')
